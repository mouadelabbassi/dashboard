...
public class AnalystController {
    ...
    @Operation(summary = "Get analyst dashboard", description = "Returns main KPIs and overview metrics")
    ...
    @Operation(summary = "Get KPI cards data", description = "Returns KPI metrics with trends")
    ...
    @Operation(summary = "Get sales overview", description = "Returns sales summary with totals")
    public ResponseEntity<ApiResponse<Map<String, Object>>> getSalesOverview(
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        Map<String, Object> sales = analystService.getSalesOverview(startDate, endDate);
        return ResponseEntity.ok(ApiResponse.success("Sales overview retrieved", sales));
    }

    @GetMapping("/sales/trends")
    @Operation(summary = "Get sales trends", description = "Returns daily/weekly/monthly sales data")
    ...
    @Operation(summary = "Get sales by category", description = "Returns revenue breakdown by category")
    ...
    @Operation(summary = "Get top selling products", description = "Returns best performing products")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getTopSellingProducts(
        ...
        return ResponseEntity.ok(ApiResponse.success("Top products retrieved", products));
    }

    @GetMapping("/sales/growth")
    @Operation(summary = "Get sales growth rate", description = "Returns growth percentage vs previous period")
    ...
    @Operation(summary = "Get peak sales times", description = "Returns heatmap data for sales by day/hour")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getPeakSalesTimes() {
        ...
        return ResponseEntity.ok(ApiResponse.success("Peak times retrieved", peakTimes));
    }

    // ==================== PRODUCT ANALYTICS ====================

    @GetMapping("/products/overview")
    @Operation(summary = "Get products overview", description = "Returns product analytics summary")
    ...
    @Operation(summary = "Get product performance matrix", description = "Returns price vs rating vs sales data")
    ...
    @GetMapping("/products/distribution/price")
    ...
    @GetMapping("/products/distribution/rating")
    ...
    @Operation(summary = "Get low stock products", description = "Returns products with low inventory")
    ...
    @Operation(summary = "Get bestseller trends", description = "Returns ranking changes over time")
    ...
    @Operation(summary = "Get sellers overview", description = "Returns seller analytics summary")
    ...
    @Operation(summary = "Get sellers ranking", description = "Returns top sellers by revenue")
    ...
    @Operation(summary = "Get seller growth", description = "Returns new sellers over time")
    ...
    @Operation(summary = "Get platform vs sellers comparison", description = "Compares MouadVision vs seller performance")
    ...
    @Operation(summary = "Get seller details", description = "Returns detailed analytics for a specific seller")
