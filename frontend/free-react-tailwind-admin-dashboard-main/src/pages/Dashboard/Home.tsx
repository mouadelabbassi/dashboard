                ...
                {adminStats && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <Link
                            ...
                            className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white hover:shadow-xl transition transform hover:scale-105"
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Pending Approvals</p>
                            ...
                            <p className="text-gray-200 text-xs mt-2">Click to review →</p>
                        </Link>
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Platform Revenue</p>
                            ...
                            <p className="text-gray-200 text-xs mt-2">From confirmed orders</p>
                        </div>
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Total Sellers</p>
                            ...
                            <p className="text-gray-200 text-xs mt-2">Active sellers</p>
                        </div>
                        <div className="bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl shadow-lg p-5 text-white">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-gray-100 text-sm font-medium">Total Clients</p>
                            ...
                            <p className="text-gray-200 text-xs mt-2">Registered</p>
                        </div>
                    </div>
                )}
                <div className="mb-6">
