...
const ShopPage: React.FC = () => {
    ...
    const handleAddToCart = (product: Product) => {
        const quantity = quantities[product.asin] || 1;
    ...
    const updateQuantity = (asin: string, value: number) => {
        setQuantities(prev => ({ ...prev, [asin]: Math.max(1, value) }));
    };
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg">
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                    updateQuantity(product.asin, (quantities[product.asin] || 1) - 1);
                                                }}
                                                className="px-2 py-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-l-lg"
                                            >
                                                -
                                            </button>
                                            <input
                                                type="number"
                                                min="1"
                                                value={quantities[product.asin] || 1}
                                                onChange={(e) => {
                                                    e.preventDefault();
                                                    updateQuantity(product.asin, parseInt(e.target.value) || 1);
                                                }}
                                                onClick={(e) => e.preventDefault()}
                                                className="w-12 text-center bg-transparent border-0 focus:ring-0 text-gray-900 dark:text-white"
                                            />
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                ...
                                                className="px-2 py-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-r-lg"
                                            >
                                                +
                                            </button>
                                        </div>
                                        <button
                                            ...
                                            className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:shadow-lg hover:shadow-purple-500/30 transition-all font-medium"
                                        >
                                            Add to Cart
                                        </button>
                                    </div>
